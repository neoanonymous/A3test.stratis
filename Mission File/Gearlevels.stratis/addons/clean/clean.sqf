...
_deadMenLimit = 30;								// Bodies. Set -1 to disable. DEF 30
...
_deadVehicleDist = 250;							// Distance (meters) from players that destroyed vehicles are not deleted if below max.
_craterLimit = 2;								// Craters. Set -1 to disable.                         DEF 5
_craterDistCheck = TRUE;						// TRUE to delete any craters that are far from players.
_craterDist = 50;								// Distance (meters) from players that craters are not deleted if below max.
_weaponHolderLimit = 10;						// Weapon Holders. Set -1 to disable.                  DEF 20
_weaponHolderDistCheck = TRUE;					// TRUE to delete any weapon holders that are far from players.
_weaponHolderDist = 25;							// Distance (meters) from players that ground garbage is not deleted if below max.             DEF 5
...
_minesDist = 1000;								// Distance (meters) from players that land mines are not deleted if below max.
