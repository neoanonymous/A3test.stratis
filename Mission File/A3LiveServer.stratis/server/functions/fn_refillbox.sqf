...
switch (_boxType) do
{
	...
	case "mission_USSpecial":
	{
		...
		[
			...
			["itm", ["optic_Aco", "optic_Aco_grn", "optic_MRCO", "optic_Hamr", "optic_Arco", "optic_Nightstalker", "optic_tws_mg", "optic_tws", "Laserdesignator", "H_HelmetO_ViperSP_hex_F"], RANDOM_BETWEEN(2,4)],
	...
	case "mission_Main_A3snipers":
	{
		...
		[
			...
			["itm", ["optic_AMS", "optic_AMS_khk", "optic_AMS_snd", "optic_KHS_blk", "optic_KHS_hex", "optic_KHS_tan", "optic_Nightstalker", "optic_tws_mg", "optic_tws", "Laserdesignator_02", "H_HelmetO_ViperSP_ghex_F"], RANDOM_BETWEEN(1,3)],
